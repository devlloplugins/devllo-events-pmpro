...
function devllo_events_show_details_callback_function( $post ) {
    ...
    <?php _e('Show Event Website:', 'devllo-events-pmpro'); ?> <input type="checkbox" id="devllo_show_event_website_field" name="devllo_show_event_website_field" value="yes" <?php echo (($dvshoweventWebsite=='yes') ? 'checked="checked"': '');?>/><br/>
